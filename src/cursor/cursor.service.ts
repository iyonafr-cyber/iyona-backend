...
const FULL_BUILD_TASK = [
  ...
  IMAGE_SOURCES_FOR_WORKER,
  'SECTION BACKGROUNDS: keep the page body neutral. The blocks above already carry each section\'s treatment — reach for the kit gradient utilities (`.bg-gradient-mesh`, `.bg-gradient-brand`, `.bg-gradient-subtle`, `.text-gradient`) only for the bespoke sections you compose yourself, and vary them rather than repeating one treatment down the page.',
  '',
